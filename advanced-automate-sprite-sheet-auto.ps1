...
foreach ($group in $groupedFiles) {
    ...
    # Resize the generated sprite sheet
    Write-Host "Resizing generated file: $outputFile"
    powershell -ExecutionPolicy Bypass -File "$PSScriptRoot\resize_by_percentage_auto.ps1" -filePath "$outputFile" -percentage 50 -quality -1
